...
$meta_boxes[] = array(
	...
	'fields' => array(							// list of meta fields
		array(
			...
			'id' => $cwpt_prefix . 'fname',				// field id, i.e. the meta key
			'type' => 'text',						// text box
...
$meta_boxes[] = array(
	...
	'fields' => array(
		array(
			...
			'id' => $cwpt_prefix . 'color',
			'type' => 'color'						// color
		),
		array(
			'name' => 'Your hobby',
			'id' => $cwpt_prefix . 'hobby',

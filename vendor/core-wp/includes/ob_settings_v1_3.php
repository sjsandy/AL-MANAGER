...
var $menu = array( 
	...
	'title' => "OB Slideshow",  // page title that is displayed 
	'intro_text' => "This allows you to configure the slideshow exactly the way you want it", // text below title
	'nav_title' => "OB Slideshow" // how page is listed on left-hand Settings panel
	);
